...
def main(): ## Runs differential equation for time span and outputs results to
    ...
    results = pd.DataFrame(results,
                           columns=["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                    ...
                                    "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                    "PCr_c", "AMP_c"])
    results.to_csv("../results/resultsReperfusionPool12mTAL.csv")

    ## Halved/Bad OXPHOS/Pool, single stage
    pc.finalConditions = finalIschemia
    pc.finalConditions[pc.pcIS.iO2_x] = normO2
    pc.finalConditions[pc.pcIS.iPYR_x] = normPYR
    ...
    results = pd.DataFrame(results,
                           columns=["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                    ...
                                    "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                    "PCr_c", "AMP_c"])
    results.to_csv("../results/resultsReperfusionOXPHOSPool12mTAL.csv")
    ...
    results = pd.DataFrame(results,
                           columns=["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                    ...
                                    "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                    "PCr_c", "AMP_c"])
    results.to_csv("../results/resultsReperfusionHalvedOXPHOSPool12mTAL.csv")
