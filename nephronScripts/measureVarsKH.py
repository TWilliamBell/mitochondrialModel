...
def main(): ## Runs differential equation for time span and outputs results to
    ...
    resultsKH = pd.DataFrame(resultsKH,
                           columns = ["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                      ...
                                      "PCr_c", "AMP_c"])
    resultsKH.to_csv("../results/resultsKH100.csv")
    ...
    resultsKHbase = pd.DataFrame(resultsKHbase,
                           columns = ["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                      ...
                                      "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                      "PCr_c", "AMP_c"])
    resultsKHbase.to_csv("../results/resultsKHbase.csv")
    ...
    resultsS2 = pd.DataFrame(resultsS2,
                           columns = ["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                      ...
                                      "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                      "PCr_c", "AMP_c"])
    resultsS2.to_csv("../results/resultsState2F1KH.csv")
    ...
    results = pd.DataFrame(results,
                           columns = ["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                      ...
                                      "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                      "PCr_c", "AMP_c"])
    results.to_csv("../results/resultsState2KH.csv")
    ...
    resultsLR = pd.DataFrame(resultsLR,
                           columns=["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                    ...
                                    "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                    "PCr_c", "AMP_c"])
    resultsLR.to_csv("../results/resultsState2LRKH.csv")
    ...
    resultsPO = pd.DataFrame(resultsPO,
                           columns=["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                    ...
                                    "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                    "PCr_c", "AMP_c"])
    resultsPO.to_csv("../results/resultsState2POKH.csv")
    ...
    results = pd.DataFrame(results,
                           columns = ["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                      ...
                                      "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                      "PCr_c", "AMP_c"])
    results.to_csv("../results/resultsState3KH.csv")
    ...
    results = pd.DataFrame(results,
                           columns = ["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                      ...
                                      "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                      "PCr_c", "AMP_c"])
    results.to_csv("../results/resultsLeakRespKH.csv")
    ...
    results = pd.DataFrame(results,
                           columns = ["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                      ...
                                      "FUM_c", "ICIT_i", "ICIT_c", "GLC_c", "G6P_c",
                                      "PCr_c", "AMP_c"])
    results.to_csv("../results/resultsPOKH.csv")
